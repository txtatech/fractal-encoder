...
class Fractal:
    ...
    def draw_fractal_png(
        ...
        # Calculate the offsets for centering the fractal
        x_offset = (width - side_length * cell_size) // 2
        y_offset = (height - side_length * cell_size) // 2
        ...
        for i in range(side_length):
            for j in range(side_length):
                ...
                if index < fractal_size:
                    # Calculate the cell position and add the offsets
        ...
        if filename.endswith(".png"):
            ...
            if "pnginfo" in image.info:
                ...
                if "fractal-identifier" in pnginfo:
                    ...
                    print(f"No fractal-identifier metadata found in {filename} because its a chunk.")
            else:
                print(f"No metadata found in {filename} because its a chunk.")
...
def generate_ledger_json(text, num_iterations):
    ...
    print("All files generated and outputs/ledgers/aledger.json successfully created. Working...")
